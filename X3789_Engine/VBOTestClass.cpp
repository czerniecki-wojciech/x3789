...
void VBOTestClass::PreDraw()
{
	...
	glBufferData(GL_ARRAY_BUFFER, sizeof(vertices) * sizeof(GLfloat), vertices, GL_STATIC_DRAW);	GL_ERROR();
	...
	glBufferData(GL_ARRAY_BUFFER, sizeof(colors) * sizeof(GLfloat), colors, GL_STATIC_DRAW);	GL_ERROR();
